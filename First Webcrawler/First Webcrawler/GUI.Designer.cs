 ...
 * For whatever reason, the accuracy of contact parsing is at least partially dependent on NUMBER_OF_ENTRIES + rowOffset, so that's another problem
 ...
 * Integrate the GUI
 * Refactor code to remove CONTACTS_PAGE_SEARCH_KEYWORDS size contraints
*/
...
namespace First_Webcrawler
{
    public partial class GUI : Form
    {
        ...
        public static String MAIN_URL_WRITING_COLUMN = "K";
        public static String CONTACT_URL_WRITING_COLUMN = "L";
        //email = cost
        public static String EMAIL_WRITING_COLUMN = "E";
        //phone = yes or no lodging
        public static String PHONE_WRITING_COLUMN = "F";
        //address = destination
        public static String ADDRESS_WRITING_COLUMN = "C";
        //other = available
        public static String OTHER_WRITING_COLUMN = "A";
        ...
        public static string[] URLs = new String [NUMBER_OF_ENTRIES + rowOffset];//UKURLs; //
        //public static string[] URLs = UKURLs;
        public static string[] contactURLs = new String[NUMBER_OF_ENTRIES + rowOffset];
        ...
        public static String[,] contactInfo = new String[NUMBER_OF_ENTRIES + rowOffset, 4];
        ...
        private void buttonLocateContacts_Click(object sender, EventArgs e)
        {
            ...
            while (URLIndex < NUMBER_OF_ENTRIES + rowOffset)
            {
                try
                {
                    //loop through all the entries
        ...
        private static String checkLenseLab()
        {
            ...
            if (URLIndex < NUMBER_OF_ENTRIES + rowOffset)
            {
                //get club text
                WorkBook workbook = WorkBook.Load(PATH_OF_IO_DOC);
                WorkSheet worksheet = workbook.GetWorkSheet(SHEET_NAME);
