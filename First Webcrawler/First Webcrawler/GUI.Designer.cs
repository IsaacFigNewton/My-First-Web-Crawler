        ...
        private void buttonLocateContacts_Click(object sender, EventArgs e)
        {
            while (URLIndex < NUMBER_OF_ENTRIES)
            {
                try
                {
                    ...
                    {
                        Console.WriteLine("");
                        Console.WriteLine("Made it to marker 1");
                        Console.WriteLine("");
                        ...
                        {
                            Console.WriteLine("");
                            Console.WriteLine("Made it to marker 2");
                            Console.WriteLine("");
                            ...
                            if (((url.Length > 0) && (url.Length < KNOWN_CONTACT_URLS[3].Length) && !(url.Substring(0, KNOWN_CONTACT_URLS[0].Length) == KNOWN_CONTACT_URLS[0]) && !(url.Substring(0, KNOWN_CONTACT_URLS[1].Length) == KNOWN_CONTACT_URLS[1]) && !(url.Substring(0, KNOWN_CONTACT_URLS[2].Length) == KNOWN_CONTACT_URLS[2]) && !(url.Substring(0, KNOWN_CONTACT_URLS[3].Length) == KNOWN_CONTACT_URLS[3]) && !(url.Substring(0, KNOWN_CONTACT_URLS[4].Length) == KNOWN_CONTACT_URLS[4])))
                            {
                                Console.WriteLine("");
                                Console.WriteLine("This should not be printing if the site being checked is a sinwp site");
                                Console.WriteLine("");
                            ...
                            {
                                Console.WriteLine("");
                                Console.WriteLine("Made it to marker 3.2");
                                Console.WriteLine("");
                            ...
                            Console.WriteLine("");
                            Console.WriteLine("If this is seen it means that you fucked up the if statements somehow, probably one of the first 2");
                            Console.WriteLine("");
                        }
                        else if (url == "")
                        {
